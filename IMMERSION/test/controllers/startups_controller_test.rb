...
class StartupsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create startup" do
    assert_difference('Startup.count') do
      post startups_url, params: { startup: { catch_phrase: @startup.catch_phrase, description: @startup.description, name: @startup.name, website_url: @startup.website_url } }
    end
  ...
  test "should update startup" do
    patch startup_url(@startup), params: { startup: { catch_phrase: @startup.catch_phrase, description: @startup.description, name: @startup.name, website_url: @startup.website_url } }
